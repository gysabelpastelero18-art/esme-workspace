            ...
            {showWarehouseModal && (
              <div style={{
                ...
                <div style={{
                  ...
                  <button onClick={() => handleWarehouseGroupSelect('NonFood')} style={{margin: '0.5rem', padding: '0.8rem 2rem', fontSize: '1.1rem', borderRadius: '8px', background: '#A3B18A', color: 'white', border: 'none', fontWeight: 600}}>NonFood</button>
                </div>
              </div>
            )}
