      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit}>
          <table className="dsr-table">
            <tbody>
              <tr>
                <th colSpan={8} className="center" style={{ fontSize: '1.3em' }}>DAILY SALES REPORT</th>
              </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="perc-col"></td>
              <td className="left">TOTAL</td>
              <td><input type="text" name="cash_total" className="number-input" /></td>
              <td><input type="text" name="cash_amount" className="amount-input" /></td>
            </tr>
            ...
            <tr>
              ...
              <td className="perc-col"></td>
              <td></td>
              <td className="left">Events</td>
              <td colSpan={2}><input type="text" name="events" /></td>
            </tr>
            </tbody>
          </table>
          ...
          <table className="dsr-table">
            <tbody>
              ...
              <tr>
                <td><input type="text" name="vatable_sales" className="amount-input" /></td>
                <td><input type="text" name="vat_amount" className="amount-input" /></td>
                <td><input type="text" name="vat_exempt2" className="amount-input" /></td>
                <td><input type="text" name="zero_rated" className="amount-input" /></td>
                <td><input type="text" name="vat_total" className="amount-input" /></td>
              </tr>
            </tbody>
          </table>
          ...
          <table className="dsr-table">
            <tbody>
              <tr>
                <th colSpan={4} className="left">CASH COUNT</th>
              </tr>
              <tr>
                <th></th>
                <th>Php</th>
                <th>Counted By/Time</th>
                <th>Checked By/Time</th>
              </tr>
              <tr>
                <td>AM Cash Count</td>
                <td><input type="text" name="am_cash" className="amount-input" /></td>
                <td><input type="text" name="am_counted_by" /></td>
                <td><input type="text" name="am_checked_by" /></td>
              </tr>
              <tr>
                <td>PM Cash Count</td>
              ...
              <tr>
                <td colSpan={4} className="left">Please attach Deposit Slip Here</td>
              </tr>
            </tbody>
          </table>
          ...
          <table className="dsr-table">
            <tbody>
              <tr>
                <th colSpan={2} className="left">Breakdown of Expenses</th>
              </tr>
              <tr>
                <th>Dept.</th>
                <th>Particular</th>
              ...
              <tr>
                <td colSpan={2} className="left">Pending Payment <input type="text" name="pending_payment" /></td>
              </tr>
            </tbody>
          </table>
